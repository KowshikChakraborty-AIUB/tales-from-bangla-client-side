    ...
    return (
        <div className="pt-20">
            <footer className="footer p-10 text-base-content">
                ...
                <nav>
                    <header className="font-bold text-base pb-2 normal-case">Contact</header>
                    <a className="link link-hover font-bold">Mobile: 01764199181 </a>
                    <a className="link link-hover font-bold">E-mail: kowshikchakraborty6@gmail.com </a>
                </nav>
